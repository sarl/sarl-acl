...
/**
 * This enumeration describes all available constant for Addresses as defined by FIPA for Bit-Efficient encoding, 
...
public enum Addresses {
	...
	/** Begin a collection of agent identifiers.
	 * <p>
	 * Code: {@code 0x02}.
	 */
	URL_COLLECTION_BEGIN((byte) 0x02);
	
	private final byte code;
	
	private Addresses(byte code){
		this.code = code;
	}
