...
/**
 * This enumeration describes all available constant for BinExpression as defined by FIPA for Bit-Efficient encoding, 
...
public enum BinExpression {
	...
	/** Begin a binary string.
	 * <p>
	 * Code: {@code 0xFF}.
	 */
	BIN_STRING_BEGIN((byte) 0xFF);
	
	private final byte code;
	
	private BinExpression(byte code){
		this.code = code;
	}
